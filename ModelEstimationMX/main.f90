program main
  ...
  smm%min_i00 = 3000.0d0;	smm%max_i00 = 9460d0
  smm%min_rii = 1.0800d0;	smm%max_rii = 2.8d0
  smm%min_rff = 0.0133d0;	smm%max_rff = 0.85d0
  smm%min_lbb = 0.0018d0;	smm%max_lbb = 0.021d0

  ! !Uncomment/Comment for results wit revisions
  ! smm%min_i00 = 9100.0d0;	smm%max_i00 = 9700d0
  ! smm%min_rii = 1.5d0;		smm%max_rii = 1.8d0
  ! smm%min_rff = 0.2d0;		smm%max_rff = 0.5d0
  ! smm%min_lbb = 0.007d0;	smm%max_lbb = 0.011d0
