...
subroutine secant_extended ( x, x1, x2, abserr, kmax, f, ierror, k )
  ...
  return
end subroutine secant_extended
...
subroutine traub_ostrowski ( x, abserr, kmax, f, ierror, k )
  ...
  return
end subroutine traub_ostrowski
